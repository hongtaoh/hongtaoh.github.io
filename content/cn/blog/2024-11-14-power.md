...
`$$P\left(Z \le  \frac{\bar{X} - \mu_A}{\sigma / \sqrt{n}} - z_{\alpha/2}\right) = \Phi\left(\frac{\mu_0 - \mu_A}{\sigma / \sqrt{n}} - z_{\alpha/2}\right)$$`

同样

`$$P(\bar{X} \ge \mu_0 + z_{\alpha/2} \cdot \frac{\sigma}{\sqrt{n}} | \mu = \mu_A) = 1- \Phi\left(\frac{\mu_0 - \mu_A}{\sigma / \sqrt{n}} + z_{\alpha/2}\right)$$`

最后的结果是

`$$\Phi\left(\frac{\mu_0 - \mu_A}{\sigma / \sqrt{n}} - z_{\alpha/2}\right) + \left[1- \Phi\left(\frac{\mu_0 - \mu_A}{\sigma / \sqrt{n}} + z_{\alpha/2}\right) \right] = 1 - \beta$$`
