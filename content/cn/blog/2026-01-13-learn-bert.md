...
3. 经过多层的 Self-Attention (Multi-Head Attention)，得到每个字新的向量表示。这一点我们接下来讲。
...
我用 Claude 生成了 100 个简单的英文句子。首先，我们得到所有单独的词，制作一个 TOKEN-EMBEDDING 查找表，这里要加上一个 `[MASK]`。我们把这个表叫做 `$E$`，也是随机初始化。
