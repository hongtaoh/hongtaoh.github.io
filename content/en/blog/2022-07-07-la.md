...
But why? Why the addition of vectors is defined this way but not another? We can think of vectors as something that represents certain movements (which contain (1) direction and (2) steps). The result of the addition of B to A is the result of A movement + B movement. 
