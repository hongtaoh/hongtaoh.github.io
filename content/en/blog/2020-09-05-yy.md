...
During the writing group this week, [Jisung](https://github.com/jisungyoon) asked how to write a research statemnt. YY shared some advice and [resources](https://yyiki.org/wiki/Research%20statement/).
...
- In your RS, you are supposed to connect your current research to your future research, both "real" ones and "imagained" ones.
...
[Munjung](https://munjungkim.github.io/about/) asked how to have a regular life. I find it a very interesting and useful topic. Here are some suggestions, mainly from YY:
  ...
  2. Schedule time for exercise before each semester. Make it unchangable. Otherwise, you'll end up having no time to exercise.
...
- On a team project, if you lead it, it's beneficial if you have a document containing the stetch of your papers, your ideas, methods, etc. This way, other people can view it as the project is going on. If you share with others your key ideas after the study is done, then if someone diagress with a certain section, the study needs to be redone. It wastes time.
...
### Update: 2021-11-15, Writing group (What is a dissertationn proposal for natural and engineering sciences)
...
- The first author prepares the draft of the response. S/he will copy and paste every point, and draft out the major points of reponses. 
