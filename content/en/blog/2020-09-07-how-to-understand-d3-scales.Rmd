...
Now that we know how `d3.scaleLinear()` transforms data from the input domain to the output range, let's think about what does this transformation preserve. 
